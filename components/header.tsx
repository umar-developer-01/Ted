...
const Header = () => {
    return (
        <header className="w-full h-[74px] flex items-center justify-between border-t border-b-2 border-gray-300 shadow-md px-4">
            ...
            <nav className="hidden lg:block mr-4">
                <ul className="flex items-center gap-6 text-gray-900 font-medium">
                    ...
                    <li>
                        <button
                            aria-label="Search"
                            className="p-1 rounded-md hover:bg-gray-100 transition duration-300 ease-in-out"
                        >
                            <svg
            ...
            {/* Mobile Hamburger */}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-9 w-9 lg:hidden">
            ...
            {/* Mobile Signin - Wrapped with Link */}
            <Link
                href="/login"
                className="cursor-pointer text-black hover:text-red-600 transition duration-300 ease-in-out mr-2 lg:hidden"
            >
                Signin
            </Link>
        </header>
